...
namespace vector
{
    ...
    {
        double x1, x2, y1, y2, x, y, l1, l2, l;       
        ...
        public void Calc()
        {
            ...
            textBox6.Text = Convert.ToString(l2);
        ...
        { 
            ...
            W = pictureBox1.Width;
            g.DrawLine(new Pen(Brushes.Black, 2), 0, W / 2, H, W / 2); 
            g.DrawLine(new Pen(Brushes.Black, 2), H / 2, 0, H / 2, W);    
            i = W / 2;                                                                     
            while (i <= W)
            {
                g.DrawLine(new Pen(Brushes.Black, 1), 0, i, H, i);
                i += 15; 
            }          
            while (i >= 0)
            { 
            ...
            while (i <= H)
            { 
                g.DrawLine(new Pen(Brushes.Black, 1), i, 0, i, W); 
                i += 15;
            } 
            while (i >= 0) 
            { 
            ...
            {
                g.DrawLine(new Pen(Brushes.Green, 2), new Point(Convert.ToInt32(H/2), Convert.ToInt32(W / 2)), new Point(Convert.ToInt32(H/2+x1*15+x2*15), Convert.ToInt32(W/2-y1*15-y2*15))); 
            }
            if (radioButton2.Checked == true) //ВЫЧИТАНИЕ
            { 
                g.DrawLine(new Pen(Brushes.Green, 2), new Point(Convert.ToInt32(H/2+x1*15), Convert.ToInt32(W/2-y1*15)), new Point(Convert.ToInt32(H/2+x2*15), Convert.ToInt32(W/2-y2*15))); 
            }
        }
